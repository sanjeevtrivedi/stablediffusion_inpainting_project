...
TA: Ritesh, 24m2154@iitb.ac.in


Task Description:
Use diffusion models to reconstruct missing or corrupted regions in images.

Deliverables:
Dataset preparation, understanding of inpainting techniques, experimentation, and evaluation using PSNR, SSIM, and visual quality.

Expected Deliverables:
Understand the concepts, do literture survey.
Prepare script for Inpainting using diffusion model.*
Suitable Dataset (Avoid large datasets to avoid large scale training) and Evaluation metrics.
Experimentation and Result Analysis.
Insights of the results and visualization.
